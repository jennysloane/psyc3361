...
- think about 1 of your exploratory analyses questions
- what type of variables will you be looking at (i.e. continuous or categorical)?
- draw a plot with your x and y axes labeled and do your best to create what you think your results would look like
*example: penguins dataset: are males heavier than females? (x = sex, y = body mass, type of plot = boxplot)*
