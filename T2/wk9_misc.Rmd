...
- keep in mind, there is not one right answer, there are pros and cons to each method, but this is a decision that is up to you. Some options are:
  ...
  - for an example of using case_when() see notes from Week 5 [here (under descriptive stats)](https://rpubs.com/jsloane/tables_ggplot_challenge_answers)
