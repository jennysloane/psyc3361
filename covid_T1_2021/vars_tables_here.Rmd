...
```{r}
mydat <- read_csv("covid_T1_2021/data_forensic.csv")
...
forensic <- read_csv("covid_T1_2021/data_forensic.csv") # that works because this csv is in our current working directory
...
group1 <- read_csv("covid_T1_2021/data/1_carstensen/AgeAdvantagesEmotionCovid_Data.csv") # this would work, I just started typing "age" and then tab to select the right file and it automatically filled in the rest

# or we can use the here function
group1 <- read_csv(here("covid_T1_2021", "data", "1_carstensen", "AgeAdvantagesEmotionCovid_Data.csv"))
group1 <- read_csv(here("./covid_T1_2021/data/1_carstensen/AgeAdvantagesEmotionCovid_Data.csv"))
...
# Group 5 (Emily, Alison, Jacqueline, Wonjae, Thomas)