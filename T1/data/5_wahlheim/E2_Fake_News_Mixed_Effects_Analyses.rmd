...
```{r}
#Read 1803.3 data
cued_recall <- read.csv("Experiment_2_Fake_News.csv", stringsAsFactors = FALSE, fileEncoding="UTF-8-BOM")
```
...
#create binary varaibles for each classification type
...
#move 1.o responses up a little
belief_correct_sub_df$emmean <- ifelse(belief_correct_sub_df$emmean == 1, 1.04, belief_correct_sub_df$emmean)
...
ggsave("Fig_4_E2_Recall_and_Beliefs.pdf", plot = e1_recall_and_belief_plots, width = 8.85, height = 9, units = "in", dpi = 320, device = "pdf")
ggsave("Fig_4_E2_Recall_and_Beliefs.png", plot = e1_recall_and_belief_plots, width = 8.85, height = 9, units = "in", dpi = 320, device = "png")
...
correction_rem_emmeans_df$Classification <- "Retraction Remembered"
...
#reorder factor levels
change_class_emmeans_df$Classification <- factor(change_class_emmeans_df$Classification, levels = c("Misinformation Recollected", "Retraction Remembered"))
...
correct_rem_sub_df$Classification <- "Retraction Remembered"
...
#reorder factor levels
correction_class_sub_df$Classification <- factor(correction_class_sub_df$Classification, levels = c("Misinformation Recollected", "Retraction Remembered"))
...
ggsave("Fig_5_E2_Change_Classifications.pdf", plot = correction_all, width = 8, height = 5, units = "in", dpi = 320)
ggsave("Fig_5_E2_Change_Classifications.png", plot = correction_all, width = 8, height = 5, units = "in", dpi = 320)
...
P1_intrusion_bubble_df$x_pos <- c(1, 3, 2, 2, 2, 4, 4, 4)
...
ann_text_class_1a <- data.frame(ItemType = 2, prob = c(.98, .48, .12), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Fact Recall")
ann_text_class_1b <- data.frame(ItemType = 4, prob = c(.99, .67, .16), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Fact Recall")
ann_text_class_2a <- data.frame(ItemType = c(2.45, 2.45, 2), prob = c(.00, .12, .41), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Misinformation Intrusions")
ann_text_class_2b <- data.frame(ItemType = c(4.50, 4.50, 4), prob = c(.00, .10, .33), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Misinformation Intrusions")

#Create data frames for line segments
panel1a <- data.frame(x = 1.15, y = .522, xend = 1.9, yend = c(.25, .61, .85), ResponseType = "Fact Recall")
panel1b <- data.frame(x = 3.15, y = .731, xend = 3.9, yend = c(.33, .78, .89), ResponseType = "Fact Recall")
panel2a <- data.frame(x = 1.15, y = .136, xend = 1.9, yend = c(.03, .10, .25), ResponseType = "Misinformation Intrusions")
panel2b <- data.frame(x = 3.15, y = .056, xend = 3.9, yend = c(.01, .05, .16), ResponseType = "Misinformation Intrusions")
...
#create variable for x position of points
belief_correct_bubble_df$x_pos <- c(1, 3, 2, 2.15, 2, 4.25, 4.20, 4)
...
Fit Mixed Effects Model to Misinformation Intrusions excluding Misinformation Recollection
...
```{r fig.height=5, fig.width=10}
#create data frames text labels
ann_text_class_1a <- data.frame(ItemType = c(2.00, 2.55, 2.00), prob = c(5.45, 4.70, 3.85), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Fact Recall")
ann_text_class_1b <- data.frame(ItemType = c(3.65, 4.60, 4.25), prob = c(5.55, 5.10, 4.15), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Fact Recall")
ann_text_class_2a <- data.frame(ItemType = c(1.55, 2.40, 2.52), prob = c(3.50, 2.90, 4.85), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Misinformation Intrusions")
ann_text_class_2b <- data.frame(ItemType = c(3.55, 4.40, 4.60), prob = c(2.60, 4.95, 3.50), lab = c("Misinformation\nRecollected", "Correction\nRemembered", "Correction\nNot Remembered"), ResponseType = "Misinformation Intrusions")

#Create data frames for line segments
panel1a <- data.frame(x = 1.15, y = 4.76, xend = c(1.9, 2.1, 1.9), yend = c(4.33, 4.75, 4.97), ResponseType = "Fact Recall")
panel1b <- data.frame(x = 3.15, y = 5.16, xend = c(4.15, 4.15, 3.85), yend = c(4.62, 5.05, 5.25), ResponseType = "Fact Recall")
panel2a <- data.frame(x = 1.15, y = 4.03, xend = c(1.95, 1.90, 1.85), yend = c(4.25, 3.70, 3.88), ResponseType = "Misinformation Intrusions")
panel2b <- data.frame(x = 3.15, y = 3.93, xend = c(3.95, 3.90, 3.85), yend = c(3.92, 4.12, 3.70), ResponseType = "Misinformation Intrusions")
...
ggsave("Fig_6_E2_Conditional_Analyses.pdf", plot = e1_cond_recall_and_belief_plots, width = 10, height = 10, units = "in", dpi = 320)
ggsave("Fig_6_E2_Conditional_Analyses.png", plot = e1_cond_recall_and_belief_plots, width = 10, height = 10, units = "in", dpi = 320)
